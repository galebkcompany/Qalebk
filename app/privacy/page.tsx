          ...
          <div className="container max-w-4xl mx-auto space-y-8">
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed">
                تلتزم قالبك بحماية خصوصية عملائها. توضح هذه السياسة كيفية جمع
                واستخدام وحماية بيانات العملاء.
              </p>
            </section>
              ...
              <div className="space-y-4 mr-6">
                <div>
                  ...
                  <p className="text-gray-700 mb-2">
                    يتم جمع عنوان البريد الإلكتروني للعميل لأغراض:
                  </p>
                  <ul className="space-y-1 mr-4 text-gray-700 text-sm">
                    ...
                    <li className="flex items-start">
                      <span className="ml-2">•</span>
                      <span>
                        إرسال إشعارات حول تحديثات الخدمة أو عروض جديدة.
                      </span>
                    </li>
                    <li className="flex items-start">
                      <span className="ml-2">•</span>
                ...
                <div>
                  ...
                  <p className="text-gray-700 mb-2">
                    في حالة استخدام خدمة الاستضافة، نجمع:
                  </p>
                  <ul className="space-y-1 mr-4 text-gray-700 text-sm">
                    <li className="flex items-start">
                      <span className="ml-2">•</span>
                    ...
                    <li className="flex items-start">
                      <span className="ml-2">•</span>
                      <span>
                        معلومات الدفع (يتم معالجتها بواسطة Lemon Squeezy ولا
                        نحتفظ بها).
                      </span>
                    </li>
                    <li className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    قد نجمع معلومات حول كيفية استخدام الموقع (عناوين IP، نوع
                    المتصفح، صفحات الزيارة) لتحسين الخدمة.
                  </p>
                </div>
              </div>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                تتخذ قالبك إجراءات أمنية مناسبة لحماية بيانات العملاء من الوصول
                غير المصرح به أو الفقدان أو التعديل. تشمل هذه الإجراءات:
              </p>
              <ul className="space-y-2 mr-6 text-gray-700">
                <li className="flex items-start">
                  <span className="ml-3 font-bold">•</span>
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                يتحمل العميل المسؤولية القانونية الكاملة عن محتوى الصور التي
                يرفعها على استضافتنا، ويُمنع رفع صور تنتهك الآداب العامة أو حقوق
                الملكية.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                <strong>لا تقوم قالبك ببيع بيانات العملاء لأي طرف ثالث</strong>.
                ومع ذلك، قد نشارك البيانات في الحالات التالية:
              </p>
              <div className="space-y-3 mr-6">
                <div>
                  ...
                  <p className="text-gray-700">
                    Paddle (معالج الدفع): يتم معالجة معلومات الدفع الخاصة بك
                    بواسطة Paddle بصفتها التاجر المسجل. نحن لا نطلع ولا نحتفظ
                    ببيانات بطاقتك الائتمانية. يمكنك الاطلاع على سياسة خصوصية
                    Paddle عبر موقعهم الرسمي.
                  </p>
                </div>
                <div>
                  <h3 className="font-semibold text-gray-900">
                  ...
                  <p className="text-gray-700">
                    عند الحاجة للامتثال للقوانين أو الاستجابة لطلبات السلطات
                    المختصة.
                  </p>
                </div>
              </div>
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed mb-4">يحق للعميل:</p>
              <ul className="space-y-2 mr-6 text-gray-700">
                <li className="flex items-start">
                  <span className="ml-3 font-bold">•</span>
                ...
                <li className="flex items-start">
                  <span className="ml-3 font-bold">•</span>
                  <span>
                    طلب حذف بيانته الشخصية (مع الالتزام بالقوانين المعمول بها).
                  </span>
                </li>
                <li className="flex items-start">
                  <span className="ml-3 font-bold">•</span>
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed">
                يستخدم الموقع ملفات تعريف الارتباط لتحسين تجربة المستخدم. يمكن
                للعميل تعطيل ملفات تعريف الارتباط من خلال إعدادات المتصفح.
              </p>
            </section>
            ...
            <section className="bg-gray-50 p-6 rounded-lg border border-gray-200">
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                التواصل معنا عبر البريد الإلكتروني التالي:
              </p>
