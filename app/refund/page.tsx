    ...
    <div className="min-h-screen bg-white text-black">
      ...
      <main className="py-12">
        <div className="container max-w-4xl mx-auto space-y-8">
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4">طبيعة المنتجات الرقمية</h2>
            <p className="text-gray-700 leading-relaxed">
              تقدم قالبك منتجات رقمية غير ملموسة (أكواد برمجية). بموجب طبيعة هذه المنتجات، يتم تسليمها فوراً عند إتمام عملية الدفع. نظراً لأن المنتجات الرقمية لا يمكن إرجاعها أو استبدالها بعد التسليم، فإن سياسة الاسترجاع الخاصة بنا تتبع المعايير الدولية للمنتجات الرقمية.
            </p>
          </section>

          {/* Accepted Refund Cases */}
          <section>
            <h2 className="text-2xl font-bold mb-4">حالات الاسترجاع المقبولة</h2>
            <p className="text-gray-700 leading-relaxed mb-4">
              لا يوجد استرجاع بمجرد إتمام الدفع واستلام الكود، باستثناء الحالات التالية:
            </p>
          ...
          {/* Refund Exceptions */}
          <section>
            <h2 className="text-2xl font-bold mb-4">استثناءات من الاسترجاع</h2>
            <p className="text-gray-700 leading-relaxed mb-4">
            ...
            <ul className="space-y-2 mr-6 text-gray-700">
              <li className="flex items-start">
                ...
                <span>إذا كان الخلل ناتجاً عن تعديلات أجراها العميل على الكود.</span>
              </li>
              <li className="flex items-start">
                <span className="ml-3 font-bold">•</span>
              ...
              <li className="flex items-start">
                <span className="ml-3 font-bold">•</span>
                <span>إذا كان الكود قد تم استخدامه بالفعل في متجر حي أو تم توزيعه على أطراف ثالثة.</span>
              </li>
              <li className="flex items-start">
                <span className="ml-3 font-bold">•</span>
                <span>إذا كان الطلب يتعلق برغبة العميل الشخصية في عدم الرضا عن التصميم أو الوظائف.</span>
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              عند الموافقة على طلب الاسترجاع، سيتم استرجاع المبلغ إلى حساب العميل الأصلي خلال 5-10 أيام عمل. قد تختلف المدة حسب البنك أو خدمة الدفع المستخدمة.
            </p>
          </section>
          ...
          <section className="bg-gray-50 p-6 rounded-lg border border-gray-200">
            ...
            <ul className="space-y-3 text-gray-700">
              <li className="flex items-start">
                <span className="ml-3 font-bold">•</span>
                <span>جميع طلبات الاسترجاع يجب أن تكون مدعومة بأدلة واضحة وموثقة.</span>
              </li>
              <li className="flex items-start">
                <span className="ml-3 font-bold">•</span>
              ...
              <li className="flex items-start">
                <span className="ml-3 font-bold">•</span>
                <span>نحتفظ بالحق في رفض طلبات الاسترجاع التي لا تستوفي الشروط المذكورة أعلاه.</span>
              </li>
            </ul>
          </section>
          ...
          {/* Contact */}
            <section className="bg-gray-50 p-6 rounded-lg border border-gray-200">
              ...
              <p className="text-gray-700 leading-relaxed">
                إذا كان لديك أي أسئلة أو استفسارات بخصوص سياسة الاسترجاع، لا تتردد في التواصل معنا عبر البريد الإلكتروني التالي:
              </p>
