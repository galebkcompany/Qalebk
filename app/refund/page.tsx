        ...
        <main className="py-12">
          <div className="container max-w-4xl mx-auto space-y-8">
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed">
                عند الموافقة على طلب الاسترجاع من قبل فريق "قالبك"، سيتم توجيه
                Paddle (معالج الدفع لدينا) لإعادة المبلغ إلى حسابك الأصلي.
                تستغرق العملية عادةً من 5-10 أيام عمل وفقاً لسياسات البنك
                وPaddle.
              </p>
            </section>
