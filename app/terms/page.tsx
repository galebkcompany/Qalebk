          ...
          <div className="container max-w-4xl mx-auto space-y-8">
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed  mb-4">
                مقدمة يرحب بك موقع قالبك (المملوك لـ: Mohannad Ibrahim Mukhtar).
                يتم تنظيم استخدامك لخدماتنا بموجب شروط الاستخدام التالية. بمجرد
                شرائك لأي منتج، فإنك توافق على هذه الشروط.
              </p>

              <p className="text-gray-700 leading-relaxed mb-4">
                قالبك هو منصة رقمي رائد متخصص في توفير أقسام واجهة مستخدم (UI
            ...
            <section>
              <h2 className="text-2xl font-bold mb-4">
                معالجة المدفوعات والضرائب (Merchant of Record)
              </h2>
              <p className="text-gray-700 leading-relaxed">
                يتم توفير خدمات الدفع ومعالجة الطلبات على هذا الموقع بواسطة
                Paddle، وهي التاجر المسجل (Merchant of Record) لجميع طلباتنا.
                تتولى Paddle معالجة المدفوعات، الضرائب، وخدمة العملاء المتعلقة
                بالعمليات المالية. عند إتمام الشراء، ستخضع أيضاً لشروط وأحكام
                Paddle.
              </p>
            </section>
