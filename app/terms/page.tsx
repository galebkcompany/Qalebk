    ...
    <div className="min-h-screen bg-white text-black">
      ...
      <main className="py-12">
        <div className="container max-w-4xl mx-auto space-y-8">
          ...
          {/* Services Definition */}
          <section>
            <h2 className="text-2xl font-bold mb-4">تعريف المنتجات والخدمات</h2>
            <p className="text-gray-700 leading-relaxed mb-4">
              تقدم قالبك أكواداً برمجية جاهزة (HTML/CSS/JavaScript) مصممة خصيصاً
              للمتاجر الإلكترونية. تشمل خدماتنا:
            </p>
          ...
          {/* Ownership and Usage */}
          <section>
            <h2 className="text-2xl font-bold mb-4">شروط الملكية والاستخدام</h2>
            <p className="text-gray-700 leading-relaxed mb-4">
            ...
            <ul className="space-y-2 mr-6 text-gray-700">
              ...
              <li className="flex items-start">
                ...
                <span>
                  ...
                  كنت مصمماً، يجب شراء ترخيص منفصل لكل عميل او التواصل مع المالك
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              تحديثات تجريها منصات المتاجر (مثل سلة أو زد وغيرها) قد تؤدي لتعطل
              الكود مستقبلاً، ولكننا سنبذل جهدنا لتوفير تحديثات متوافقة, في حالة
              قيام العميل بتعديل الكود بطريقة خاطئة وأدت إلى تعطل متجره أو ظهور
              أخطاء، فإن قالبك غير مسؤولة عن إصلاح هذه الأخطاء أو تعويض العميل
              عن أي خسائر ناتجة عنها.
            </p>
          </section>
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4">العمر القانوني والصلاحية</h2>
            <p className="text-gray-700">
          ...
          <section className="bg-gray-50 p-6 rounded-lg border border-gray-200 mb-8">
            ...
            <p className="text-gray-700">
              يتفق الطرفان على الاختصاص الحصري للمحاكم السعودية في حالة حدوث أي
              نزاع.
            </p>
          </section>
